...
initMap = () => {
  ...
  L.tileLayer('https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.jpg70?access_token={mapboxToken}', {
    mapboxToken: 'pk.eyJ1IjoiYWxpemF0YW0iLCJhIjoiY2pyOW93ZHBxMGJ3bjQ1cW1jMTZiYWpvMyJ9.o4X6RTSyZCw14ag2B3yQUg',
    maxZoom: 18,
...
createRestaurantHTML = (restaurant) => {
  ...
  more.setAttribute('aria-label', `view details of the ${restaurant.name}`);
